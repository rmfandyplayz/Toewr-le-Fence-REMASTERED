...
public abstract class StatusEffectFunctionality //class 2a
{
	...
	public virtual float ImmuneToEffectTimer() //FUNC_#1
    {
        return 0f;
    }
	
	public virtual void RunStatusEffect(StatusEffectHoldable statusEffectHolder, UnityAction<StatusEffectFunctionality> callback) //FUNC_#2
    {
		return;
    }
...
public abstract class StatusEffectFunctionality<DataType> : StatusEffectFunctionality
{
	public GameObject targetOfStatusEffect;
	public DataType statusEffectData;
}
